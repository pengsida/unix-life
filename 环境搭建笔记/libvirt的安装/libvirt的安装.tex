...
\section{libvirt的安装}
	...
	接下来还需要安装几个包来使用libvirt的虚拟网络，步骤如下：
	\begin{itemize}
		\item[1.] 安装bridge-utils、ebtables、firewalld和dnsmasq，命令如下：
		\begin{lstlisting}
	...
	sudo apt install dnsmasq
		...
		\item[2.] 启动firewalld服务，并重启libvirt，命令如下：
		\begin{lstlisting}
	...
	sudo systemctl restart libvirtd
		...
		\item[3.] 查看虚拟网络是否可以使用，命令如下：
		\begin{lstlisting}
	sudo libvirtd
	sudo virsh net-list
		\end{lstlisting}

		如果有看到default网络，就说明libvirt虚拟网络可以使用。
	\end{itemize}
