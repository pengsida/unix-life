...
\section{String类}
	...
	各种语言都有自己所支持的配置文件，配置文件中很多变量是经常改变的，这样做也是为了方便用户，让用户能够脱离程序本身去修改相关的变量设置。
...
\subsection{split}
	...
	说明：\par
	split 方法的结果是一个字符串数组，在 stingObj 中每个出现 separator 的位置都要进行分解\par

	参考网站：\par
	\url{http://www.cnblogs.com/liubiqu/archive/2008/08/14/1267867.html}
